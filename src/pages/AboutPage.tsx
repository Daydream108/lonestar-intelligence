...
const ValueCard: React.FC<{ title: string; description: string; icon: React.ReactNode }> = ({ title, description, icon }) => {
    return (
        <div className="text-center p-6">
            <div className="flex items-center justify-center mx-auto mb-4 w-12 h-12 text-brand-dark">
                {icon}
            </div>
...
const personSchema = {
  ...
  "image": "https://www.lonestarintelligence.co/brett-pascall.jpg",
    ...
    <>
      ...
      <SectionWrapper>
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl font-bold text-brand-dark mb-4 text-center">Our Mission</h2>
      ...
      <SectionWrapper className="bg-gray-50/70">
        <div className="flex flex-col md:flex-row items-center gap-12 max-w-5xl mx-auto">
            ...
            <div className="md:w-2/3">
                ...
                <h2 className="text-3xl font-bold text-brand-dark mt-1">Brett Pascall</h2>
      ...
      <SectionWrapper className="bg-gray-50/70">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-brand-dark">Our Values</h2>
        </div>
