    ...
    return (
        <div className={`flex flex-col ${reverse ? 'md:flex-row-reverse' : 'md:flex-row'} items-center gap-12`}>
            <div className="md:w-1/2 flex justify-center p-8">
                <div className="w-48 h-48 bg-gray-100 rounded-full flex items-center justify-center text-[#0B1C2E]">
                    {icon}
                </div>
            </div>
            <div className="md:w-1/2">
                <p className="text-[#0B1C2E] font-bold tracking-wider mb-2">{step}</p>
                <h3 className="text-3xl font-bold text-[#0B1C2E] mb-4">{title}</h3>
  ...
  return (
    <>
      <SectionWrapper className="text-center bg-gray-50/70">
        <h1 className="text-4xl md:text-5xl font-extrabold text-[#0B1C2E]">From vision to execution—our process makes AI adoption real.</h1>
