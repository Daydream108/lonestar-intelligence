    ...
    <>
      ...
      <div className="bg-white relative flex items-center justify-center py-24 md:py-32">
        ...
        <div className="container mx-auto px-6 text-center relative z-10">
          <h1 className="text-4xl md:text-6xl font-extrabold text-[#0B1C2E] leading-tight mb-4">
        ...
        <div className="max-w-[560px] mx-auto px-6 text-center">
            ...
            <div className="relative inline-flex items-center justify-center my-12">
                ...
                <div className="relative flex items-center justify-center gap-5">
                    <svg viewBox="0 0 60 60" className="w-10 h-10 md:w-12 md:h-12 text-[#0B1C2E]" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="text-left">
                        <p className="text-xl md:text-2xl font-bold text-[#0B1C2E] tracking-[.02em] uppercase">LONESTAR</p>
                        <p className="text-base md:text-lg font-semibold text-[#0B1C2E] tracking-[.02em] uppercase">INTELLIGENCE</p>
                    </div>
                </div>
            </div>
            <div className="w-full h-px bg-[#E5E8EB]"></div>
      ...
      <SectionWrapper id="how-it-works" className="bg-gray-50/70">
         <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-[#0B1C2E]">From Vision to Execution in 3 Steps</h2>
        </div>
      ...
      <SectionWrapper id="services" className="bg-white">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-[#0B1C2E]">Tailored Sessions for Every Team</h2>
      ...
      {/* Final CTA */}
      <SectionWrapper>
          <div className="bg-[#0B1C2E] text-white rounded-lg p-12 text-center">
...
const TimelineStep: React.FC<{num: string; title: string; description: string}> = ({num, title, description}) => {
    return (
         <div className="text-center p-4">
            <div className="flex items-center justify-center mx-auto mb-4 w-12 h-12 bg-[#0B1C2E] text-white font-bold text-xl rounded-full">
                {num}
            </div>
            <h3 className="text-xl font-bold text-[#0B1C2E] mb-2">{title}</h3>
...
const ServiceCard: React.FC<{title: string; description: string; linkTo: string}> = ({title, description, linkTo}) => {
    return (
        <div className="bg-white p-8 rounded-lg shadow-md hover:shadow-xl transition-shadow duration-300 flex flex-col">
            ...
            <Link to={linkTo} className="font-bold text-[#0B1C2E] hover:underline self-start">Learn More →</Link>
        </div>
    )
}
