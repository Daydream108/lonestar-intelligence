    ...
    return (
        <div className="bg-white p-8 md:p-12 rounded-lg shadow-lg border border-gray-200/80">
            <div className="flex items-start gap-6">
                <div className="flex-shrink-0 text-[#0B1C2E]">{icon}</div>
                <div>
                    <h3 className="text-2xl font-bold text-[#0B1C2E] mb-3">{title}</h3>
                    <p className="text-gray-700 mb-4">{description}</p>
                    <p className="font-semibold text-[#0B1C2E]">
  ...
  return (
    <>
      <SectionWrapper className="text-center bg-gray-50/70">
        <h1 className="text-4xl md:text-5xl font-extrabold text-[#0B1C2E]">AI isn’t the future—it’s your competitive edge today.</h1>
