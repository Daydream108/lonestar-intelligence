...
const FAQItem: React.FC<{ question: string; answer: string }> = ({ question, answer }) => {
    return (
        <div>
            <h4 className="font-bold text-[#0B1C2E]">{question}</h4>
  ...
  return (
    <>
      <SectionWrapper className="text-center">
        <h1 className="text-4xl md:text-5xl font-extrabold text-[#0B1C2E]">Let's make AI real for your business.</h1>
            ...
            <div className="bg-white rounded-lg shadow-2xl overflow-hidden border border-gray-200 p-8 md:p-12">
                <form action="https://formspree.io/f/xanprbgq" method="POST" className="space-y-6">
                    <div>
                        ...
                        <input type="text" name="name" id="name" required className="w-full px-4 py-3 border border-gray-300 rounded-md focus:ring-[#0B1C2E] focus:border-[#0B1C2E]"/>
                    </div>
                     <div>
                        <label htmlFor="company" className="block text-sm font-bold text-gray-700 mb-2">Company</label>
                        <input type="text" name="company" id="company" required className="w-full px-4 py-3 border border-gray-300 rounded-md focus:ring-[#0B1C2E] focus:border-[#0B1C2E]"/>
                    </div>
                    <div>
                        <label htmlFor="email" className="block text-sm font-bold text-gray-700 mb-2">Email</label>
                        <input type="email" name="email" id="email" required className="w-full px-4 py-3 border border-gray-300 rounded-md focus:ring-[#0B1C2E] focus:border-[#0B1C2E]"/>
                    </div>
                     <div>
                        <label htmlFor="message" className="block text-sm font-bold text-gray-700 mb-2">Message</label>
                        <textarea name="message" id="message" rows={4} required className="w-full px-4 py-3 border border-gray-300 rounded-md focus:ring-[#0B1C2E] focus:border-[#0B1C2E]"></textarea>
                    </div>
                    <div>
      ...
      <SectionWrapper className="bg-gray-50/70">
        <div className="grid md:grid-cols-2 gap-12 max-w-5xl mx-auto">
            <div>
                 <h3 className="text-2xl font-bold text-[#0B1C2E] mb-6">Frequently Asked Questions</h3>
