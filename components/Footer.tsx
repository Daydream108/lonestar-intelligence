                ...
                <div>
                 ...
                 <div>
                    ...
                    <div className="mt-4 flex space-x-4">
                        <a href="https://linkedin.com/company/lonestar-intelligence" target="_blank" rel="noopener noreferrer" className="text-[#C0C7CF] hover:text-white transition-colors" aria-label="LinkedIn">
